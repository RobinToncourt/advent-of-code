...
pub mod tests_day_2 {
    ...
    use crate::solutions::{utils::inputs_to_presents, Present, wrapping_paper_order, ribbon_order};
    ...
    fn test_wrapping_paper_order_puzzle_inputs() {
        let inputs: Vec<String> = load_from_file("./src/year_2015/day_2/inputs.txt");
